        ...
        while (inTab) {
            ...
            switch (choice) {
                ...
                case "5":
                    ...
                    User friendToRemove = dbOps.getUserByUsername(removeTarget); 
                    if (friendToRemove == null) { 
                        System.out.println("User '" + removeTarget + "' not found."); 
                        break; 
                    } 
                    boolean removed = dbOps.deleteFriendship(user.getUserID(), friendToRemove.getUserID()); 
                    if (removed) { 
                        System.out.println(removeTarget + " was removed from your friends list."); 
                    } else { 
                        System.out.println("Could not remove " + removeTarget + ". You may not be friends."); 
                    } 
                    break;
                case "6":
                    System.out.println("\n[Feature: View Groups]");
                    ...
                    if (groups == null || groups.isEmpty()) { 
                        System.out.println("You are not currently in any groups."); 
                    } else { 
                        for (Group group : groups) { 
                            System.out.println("Group ID: " + group.getGroupId()); 
                            System.out.println("Members: " + group.getGroupMembers().size()); 
                            System.out.println("-------------------"); 
                        } 
                    } 
                    break;
                case "7":
                    ...
                    System.out.println("Enter usernames to add to the group."); 
                    ...
                    while (true) { 
                        ...
                        User groupMember = dbOps.getUserByUsername(username); 
                        if (groupMember == null) { 
                            System.out.println("User not found."); 
                        } else { 
                            newGroup.getGroupMembers().add(groupMember); 
                            System.out.println(groupMember.getUsername() + " added to the group."); 
                        } 
                    } 
                    newGroup.getGroupMembers().add(user); 
                    user.getJoinedGroups().add(newGroup); 
                    System.out.println("Group created locally with " + newGroup.getGroupMembers().size() + " member(s)."); 
                    break;
                case "8":
                    inTab = false;
                    break;
